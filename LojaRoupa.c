...
/*define duas estruturas: Roupa e Cliente. Cada uma representa um tipo de dado que 
...
int main() {
    // Registrar 3 roupas e 3 clientes
    Roupa roupas[] = {
        {"Camiseta", "Manga Curta", "M", 29.99, "Nike", "Azul"},
        {"Calça Jeans", "Jeans", "36", 79.99, "Levi's", "Azul"},
        {"Vestido", "Curto", "P", 49.99, "Zara", "Vermelho"}
    };
